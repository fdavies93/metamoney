...
def transactions(
    ...
    # NOTE: In reality this should be generated by a higher-order function
    def condition(entry: JournalEntry) -> bool:
        for transaction in entry.transactions:
            if (
                transaction.account.split(":")[0] == "Assets"
                and "AGODA.COM" in transaction.payee
            ):
                return True
        return False
